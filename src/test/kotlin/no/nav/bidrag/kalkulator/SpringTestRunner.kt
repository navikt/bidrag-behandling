...
@ContextConfiguration(classes = [BidragKalkulatorLocal::class])
@SpringBootTest(classes = [BidragKalkulatorLocal::class, StubUtils::class], webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
