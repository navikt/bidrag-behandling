...
@ContextConfiguration(classes = [BidragSpringAppLocal::class])
@SpringBootTest(classes = [BidragSpringAppLocal::class, StubUtils::class], webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
