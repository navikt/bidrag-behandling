...
class BehandlingControllerTest : KontrollerTestRunner() {
    ...
    @Nested
    @DisplayName("Teste opprettelse av behandling")
    open inner class OppretteBehandling {
        ...
        @Test
        @Ignore("Feiler ved clean install, men OK hvis kjøres isolert")
        ...
        fun `skal ikke opprette en behandling dersom saksnummer er mer enn sju tegn`() {
            ...
            val testBehandlingMedBlank = oppretteBehandlingRequestTest("3456789565", "en12", roller)
            val responseMedBlank =
                httpHeaderTestRestTemplate.exchange(
                    "${rootUri()}/behandling",
                    HttpMethod.POST,
    ...
    @Nested
    @DisplayName("Teste oppdatere behandling")
