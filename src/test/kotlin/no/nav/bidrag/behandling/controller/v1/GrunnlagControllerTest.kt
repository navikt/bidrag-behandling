...
class GrunnlagControllerTest : KontrollerTestRunner() {
    ...
    fun `skal returnere 404 ved ugyldig behandling id`() {
        val r =
            httpHeaderTestRestTemplate.exchange(
                "${rootUriV1()}/behandling/1232132/opplysninger/${Grunnlagstype.BOFORHOLD.name}/aktiv",
                HttpMethod.GET,
                HttpEntity.EMPTY,
                GrunnlagDto::class.java,
            )
    ...
    fun `skal returnere 404 hvis opplysninger ikke eksisterer for en gitt behandling`() {
        ...
        val r =
            httpHeaderTestRestTemplate.exchange(
                "${rootUriV1()}/behandling/${behandling.body!!.id}/opplysninger/${Grunnlagstype.BOFORHOLD.name}/aktiv",
                HttpMethod.GET,
                HttpEntity.EMPTY,
                GrunnlagDto::class.java,
            )
    ...
    fun `skal opprette og oppdatere opplysninger1`() {
        ...
        val oppAktivResult1 =
            httpHeaderTestRestTemplate.exchange(
                "${rootUriV1()}/behandling/$behandlingId/opplysninger/${Grunnlagstype.BOFORHOLD.name}/aktiv",
                HttpMethod.GET,
                HttpEntity.EMPTY,
                GrunnlagDto::class.java,
            )
        ...
        val oppAktivResult2 =
            httpHeaderTestRestTemplate.exchange(
                "${rootUriV1()}/behandling/$behandlingId/opplysninger/${Grunnlagstype.INNTEKTSOPPLYSNINGER.name}/aktiv",
                HttpMethod.GET,
                HttpEntity.EMPTY,
                GrunnlagDto::class.java,
            )
