...
class NotatServiceTest {
    ...
    open inner class OppdatereBegrunnelse {
        ...
        fun `skal opprette nytt notat`() {
            ...
            // hvis
            notatService.oppdatereNotat(behandling, Notattype.BOFORHOLD, innhold, behandling.bidragsmottaker!!)
        ...
        fun `skal oppdatere eksisterende notat`() {
            ...
            // hvis
            notatService.oppdatereNotat(behandling, notattype, nyttInnhold, rolle)
