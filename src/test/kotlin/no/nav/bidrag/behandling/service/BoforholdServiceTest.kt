        ...
        open inner class OppdatereManuelt {
            ...
            open fun `skal angre forrige endring`() {
                ...
                assertSoftly("Resultat etter første oppdatering") {
                    ...
                    husstandsmedlem.perioder.find { husstandsmedlem.perioder.first().id == it.id }?.bostatus shouldBe
    ...
    open inner class Husstandsmedlemstester {
                    ...
                    listOf(
                        RelatertPersonGrunnlagDto(
                            ...
                            borISammeHusstandDtoListe =
                                listOf(
                                    BorISammeHusstandDto(
                                        periodeFra = behandling.søknadsbarn.first().fødselsdato,
                                        periodeTil = null,
                                    ),
                                ),
                        ),
        ...
        open inner class OppdatereAutomatisk {
            ...
            open fun `skal oppdatere automatisk innhenta husstandsmedlem og slette manuelle perioder`() {
                ...
                periodisertBoforhold.groupBy { it.gjelderPersonId }.forEach { (personId, boforhold) ->
                ...
                val dataFraGrunnlag =
                    behandling.grunnlag
                        ...
                        .groupBy {
                            ...
                            val data = t.konvertereData<Set<BoforholdResponseV2>>()
                            RelatertPersonGrunnlagDto(
        ...
        open fun `skal returnere riktig kilde på bostatusperiode`() {
            ...
            val offentligeBostatuser =
                boforholdsrequest.find { it.gjelderPersonId == testdataBarn2.ident }!!.innhentedeOffentligeOpplysninger
            val request =
                boforholdsrequest
                    .find { it.gjelderPersonId == testdataBarn2.ident }!!
            ...
            // hvis
            val periodisertBoforhold =
                BoforholdApi.beregnBoforholdBarnV3(testdataBarn2.fødselsdato, listOf(periodiseringsrequest))
            ...
            open fun `skal lagre periodisert sivilstand basert på førstegangsinnhenting av grunnlag`() {
                ...
                val periodisertSivilstand =
                    SivilstandApi.beregnV2(
                        ...
                        grunnlagSivilstand.tilSivilstandRequest(fødselsdatoBm = behandling.bidragsmottaker!!.fødselsdato),
                    )
            ...
            open fun `skal oppdatere automatisk innhenta sivilstand uten å ta hensyn til manuelle perioder`() {
                ...
                val periodisertSivilstand =
                    SivilstandApi.beregnV2(
                        ...
                        grunnlagsdataSivilstand.tilSivilstandRequest(fødselsdatoBm = behandling.bidragsmottaker!!.fødselsdato),
                    )
