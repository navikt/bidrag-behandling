...
class GrunnlagServiceTest : TestContainerRunner() {
    ...
    open inner class Feilhåndtering {
        ...
        open fun `skal håndtere at bidrag-grunnlag er nede`() {
            ...
            every { bidragGrunnlagConsumerMock.henteGrunnlag(any()) } returns (HentetGrunnlag(
                null,
                "Teknisk feil ved henting av grunnlag"
            ))
        ...
        open fun `skal ikke lagre tomt grunnlag dersom innhenting feiler`() {
            ...
            Mockito.`when`(bidragGrunnlagConsumerMock.henteGrunnlag(Mockito.anyList()))
                .thenReturn(HentetGrunnlag(innhentingMedFeil))
        ...
        open fun `skal ikke lagre`() {
            ...
            Mockito
                ...
                .thenReturn(HentetGrunnlag(opprettHentGrunnlagDto()))
