...
class BehandlingServiceTest : TestContainerRunner() {
    ...
    fun `skal opprette en behandling`() {
        val createRoller = setOf<CreateRolleDto>(
            CreateRolleDto(RolleType.BIDRAGS_MOTTAKER, "123344", LocalDateTime.now()),
            CreateRolleDto(RolleType.BIDRAGS_PLIKTIG, "44332211", LocalDateTime.now()),
            CreateRolleDto(RolleType.BARN, "1111", LocalDateTime.now()),
        )
