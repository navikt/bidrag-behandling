...
/*
    ...
    ALTER TABLE BEHANDLING RENAME COLUMN BEHANDLINGSTYPE TO BEHANDLING_TYPE;
    ALTER TABLE BEHANDLING RENAME COLUMN SOKNADSTYPE TO SOKNAD_TYPE;
    ALTER TABLE BEHANDLING RENAME COLUMN MOTTATTDATO TO MOTTAT_DATO;
    ...
    ALTER TABLE BEHANDLING RENAME COLUMN BOFORHOLDSBEGRUNNELSE_KUN_NOTAT TO BOFORHOLD_BEGRUNNELSE_KUN_I_NOTAT;
    ALTER TABLE BEHANDLING RENAME COLUMN INNTEKTSBEGRUNNELSE_VEDTAK_OG_NOTAT TO INNTEKT_BEGRUNNELSE_MED_I_VEDTAK_NOTAT;
    ALTER TABLE BEHANDLING RENAME COLUMN INNTEKTSBEGRUNNELSE_KUN_NOTAT TO INNTEKT_BEGRUNNELSE_KUN_I_NOTAT;
    ALTER TABLE BEHANDLING RENAME COLUMN GRUNNLAGSPAKKEID TO GRUNNLAGSPAKKE_ID;

     DELETE FROM FLYWAY_SCHEMA_HISTORY WHERE VERSION = '1.0.44';
 */

ALTER TABLE BEHANDLING ADD COLUMN GRUNNLAG_SIST_INNHENTET TIMESTAMP WITHOUT TIME ZONE;
ALTER TABLE BEHANDLING RENAME COLUMN BEHANDLING_TYPE TO BEHANDLINGSTYPE;
