...
import no.nav.bidrag.behandling.dto.inntekt.KontatstøtteDto
...
data class OppdaterVirkningstidspunkt(
    @Schema(
        name = "årsak",
        description = "Oppdater årsak. Hvis verdien er satt til null vil årsak bli slettet. Hvis verdien er satt til tom verdi eller ikke er satt vil det ikke bli gjort noe endringer"
    )
    ...
    @Schema(
        ...
        format = "date",
        example = "2025-01-25",
        description = "Oppdater virkningsdato. Hvis verdien er satt til null vil virkningsdato bli slettet. Hvis verdien er satt til tom verdi eller ikke er satt vil det ikke bli gjort noe endringer"
    )
...
data class OppdatereInntekterRequest(
    ...
    val kontantstøtte: Set<KontatstøtteDto>? = null,
