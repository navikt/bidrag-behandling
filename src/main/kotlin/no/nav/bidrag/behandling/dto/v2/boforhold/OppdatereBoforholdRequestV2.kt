...
data class OppdatereBoforholdResponse(
    @get:Schema(description = "Oppdaterte perioder med andre voksne i Bps husstand")
    val oppdatertePerioderMedAndreVoksne: Set<BostatusperiodeDto> = emptySet(),
    @get:Schema(description = "Husstandsmedlem som ble opprettet")
    ...
    @get:Schema(description = "Erstattes av oppdatertHusstandsmedlem", deprecated = true)
    val oppdatertHusstandsbarn: HusstandsmedlemDtoV2? = oppdatertHusstandsmedlem

    @Deprecated("Erstattes av begrunnelse")
    @get:Schema(description = "Saksbehandlers notat", deprecated = true)
...
data class OppdatereAndreVoksneIHusstanden(
    @get:Schema(description = "Oppdatere bor-med-andre-voksne-status på periode")
    val oppdaterePeriode: OppdatereAndreVoksneIHusstandenperiode? = null,
    @get:Schema(type = "Long", description = "Id til perioden som skal slettes")
    val slettePeriode: Long? = null,
    @get:Schema(type = "Long", description = "Angi om historikken skal tilbakestilles til siste aktiverte grunnlagsdata")
    val tilbakestilleHistorikk: Boolean = false,
    @get:Schema(type = "Long", description = "Angi om siste endring skal angres")
    val angreSisteEndring: Boolean = false,
)

data class OppdatereAndreVoksneIHusstandenperiode(
    @get:Schema(type = "Long", description = "Id til bostatusperioden som skal oppdateres, oppretter ny hvis null")
...
data class OppdatereHusstandsmedlem(
    @get:Schema(description = "Informasjon om husstandsmedlem som skal opprettes")
    ...
    @get:Schema(type = "Long", description = "Id til husstandsmedlemmet som skal slettes")
    ...
    @get:Schema(type = "Long", description = "Id til husstandsmedlemmet siste steg skal angres for")
...
data class OppdatereBostatusperiode(
    ...
    @get:Schema(type = "Long", description = "Id til husstandsbarnet perioden skal gjelde for", deprecated = true)
    var idHusstandsbarn: Long = 0L,
    @get:Schema(type = "Long", description = "Id til husstandsmedlemmet perioden skal gjelde for")
    var idHusstandsmedlem: Long = 0L,
    @get:Schema(type = "Long", description = "Id til perioden som skal oppdateres")
    val idPeriode: Long? = null,
...
data class OppdatereSivilstand(
    ...
    @get:Schema(type = "Long", description = "Tilbakestiller til historikk fra offentlige registre")
    val tilbakestilleHistorikk: Boolean = false,
    @get:Schema(type = "Boolean", description = "Settes til true for å angre siste endring")
    val angreSisteEndring: Boolean = false,
)
