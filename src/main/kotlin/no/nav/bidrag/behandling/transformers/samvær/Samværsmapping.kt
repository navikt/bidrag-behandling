...
fun Samvær.tilBegrunnelse() =
    BegrunnelseDto(NotatService.henteNotatinnhold(behandling, NotatGrunnlag.NotatType.SAMVÆR, rolle), rolle.tilDto())

fun Samvær.tilBegrunnelseFraOpprinneligVedtak() =
    BegrunnelseDto(NotatService.henteNotatinnhold(behandling, NotatGrunnlag.NotatType.SAMVÆR, rolle, false), rolle.tilDto())
...
fun Samvær.tilDto() =
    SamværDto(
        ...
        begrunnelseFraOpprinneligVedtak = tilBegrunnelseFraOpprinneligVedtak(),
